  ...
  if (!supabase) {
    return (
      <div className="text-center py-12">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-3">Configuration Error</h1>
        <p className="text-gray-600 mb-6 text-sm">Unable to connect to the database. Please refresh the page or check your environment variables.</p>
      </div>
    );
  }
