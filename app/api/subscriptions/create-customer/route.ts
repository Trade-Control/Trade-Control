...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[Create Customer] STRIPE_SECRET_KEY_V2 check:', { hasStripeKey, keyPrefix });

    if (!stripeSecretKey) {
      console.error('[Create Customer] STRIPE_SECRET_KEY_V2 is not set in environment');
